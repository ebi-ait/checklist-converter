...
public class ChecklistConverterService {
    ...
    public String getChecklist(String checklistId) {
        ...
        try {
            ...
            List<Map<String, Object>> properties = listProperties(enaChecklist);
    ...
    public String getChecklists() {
        ...
        for (String accession : accessions) {
            try {
                ...
                log.error("problem converting checklist %s".formatted(accession));
            }
        }
...
//    String path = getClass().getClassLoader().getResource("schema").getPath() + "/";
    ...
    private List<Map<String, Object>> listProperties(EnaChecklist enaChecklist) {
    ...
    private static List<String> getStringRepresentationOfSynonyms(List<String> synonyms, String fieldName) {
